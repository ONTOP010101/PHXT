<template>
  <header class="h-16 bg-white border-b border-surface-200 flex items-center px-6 gap-4 fixed top-0 left-0 right-0 z-100">
    ...
    <div class="flex items-center gap-3">
      ...
      <!-- Notifications -->
      <button id="notif-btn" class="relative w-9 h-9 flex items-center justify-center rounded-lg hover:bg-surface-100 transition-colors" @click="toggleNotifications">
        <Bell class="w-5 h-5 text-surface-500" />
